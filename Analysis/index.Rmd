...
the participant did not select the item with the highest model weight? 
...
```{r fig.cap = "A random selection of *good* trials."}
...
Here are some typical trials. Possible we have the path-length minimisation issue again. 

```{r fig.cap = "A random selection of *typical* trials."}
...
Now let's look at less predictable trials:

```{r fig.cap = "A random selection of *hard* trials."}
