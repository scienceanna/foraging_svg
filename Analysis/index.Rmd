...
ggplot(a_acc, aes(x= condition, y = accuracy, fill = condition)) + 
  ...
  scale_y_continuous("model accuracy",  
                     limits = c(0.3, 0.8), breaks = seq(0.3, 0.8, 0.1)) -> plt_a
...
ggsave("../Figures/qjep_indiv_diff.png", 
       plt_a + plt_b + 
         plot_layout(guides = "collect") & theme(legend.position = "bottom"), width = 8, height = 4)
```
