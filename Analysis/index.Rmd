...
```{r fig.height=3.5, fig.cap = "Histogram of how predictiable indivuidual trials are, defined as how often the model assigned the largest weight to the target that was then selected."}
