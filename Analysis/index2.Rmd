...
```{r, echo = TRUE}
# read in data
d <- read_csv("data/human_data_2014_prox.csv", show_col_types = FALSE) %>%
...
a <- readRDS("scratch/kristjansson_model_weights.rda") %>%
...
# computed in xxxx.R
fit <- readRDS("scratch/kristjansson_model_fit.rda") %>%
