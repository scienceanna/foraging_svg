...
We can also repeat this calculation for the 2nd and 3rd ranked candidate items.
...
ggplot(d, aes(x, y)) + geom_hex(bins = 12) +
  scale_fill_viridis_c() -> plt_all
