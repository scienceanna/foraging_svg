...
```{r}
# set ggplot2 options
theme_set(ggthemes::theme_tufte() + theme(plot.background = element_rect(fill = "grey95", colour = "grey95")))
...
```{r, fig.cap = "Accuracy of our model appears to vary with the strength of an individual's proximity bias."}
# computed in xxxx.R
